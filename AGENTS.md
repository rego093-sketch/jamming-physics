...
|---|---|---:|---|
| R19 bistable switch | `ṡ = g·s − s³ + h` | 22 / 30 | the universal kernel |
| γ — measured stiffness | `γ = −mean NN stacking ΔG` | 22 / 30 | the biology instantiation |
...
| Jammed lattice / `c²=B/ρ` | the bare substrate | 14 / 30 | reaches into dna, eye, neuro |
| FitzHugh–Nagumo oscillator | relaxation rhythm | 11 / 30 | hearts, clocks, neurons |
...
// registry/vp.manifest.json  (the source of truth; aggregates are generated from it)
{
  ...
  "volumes": [
    { "id":"dna", "tier":2, "doi":"10.5281/zenodo.20471407", "hub":"/dna/",
      ...
      "primitives":["R19","gamma","jammed"], "sha256":"…", "ingest":"patternA" }
    /* … one row per volume … */
  ],
