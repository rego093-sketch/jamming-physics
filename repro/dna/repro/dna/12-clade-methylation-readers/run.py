#!/usr/bin/env python3
# repro/dna/12-clade-methylation-readers/run.py
#   v1.10 research extension (Workstream M*: clade-specific methylation readers) -- the plant and insect
...
#   (2) the regenerated clade_reader_results.json matches this folder's frozen expected/
...
CASES = [("clade_reader_engine.py", "clade_reader_results.json")]
