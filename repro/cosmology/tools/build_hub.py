...
REGISTRY = {
    ...
    "cosmology": {
        "repo": "https://github.com/rego093-sketch/jamming-physics",
        "branch_path": "main",
        "headline": "a₀ = cH₀/2π ≈ 1.08×10⁻¹⁰ m s⁻²",
        "xlinks": [
            ("a₀ = cH₀/2π", "06-galactic-rotation-derivation-a0-ch0",
             "§6 — Galactic rotation and the derivation a₀=cH₀/2π"),
            ("dark matter = vacuum deficit", "08-dark-matter-vacuum-deficit",
             "§8 — Dark matter as a vacuum deficit"),
            ("non-expanding lattice-optics cosmology", "07-non-expanding-lattice-optics-cosmology",
             "§7 — A non-expanding, lattice-optics cosmology"),
        ],
    },
}
