...
# -*- coding: utf-8 -*-
"""
run_all.py  --  Integumentary RESEARCH entry point. Drop into a fresh chat and run: python repro/run_all.py
...
import importlib
eng = importlib.import_module("vp_skn_engine"); stress = importlib.import_module("stress_tests")
gates = importlib.import_module("gates"); onco = importlib.import_module("carcinogen_dose_response")

def main():
    print("=" * 78); print("Integumentary  --  RESEARCH PHASE (writing is locked until gates are green)"); print("=" * 78)
