...
across the VP papers; vendored so this package reproduces offline without an upstream whitepaper.
Do not rewrite the math; report bugs to the neuro engine owner (VP-SPEC C1, primitive single-source).
