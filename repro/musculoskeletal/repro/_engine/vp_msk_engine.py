...
# -*- coding: utf-8 -*-
"""
vp_msk_engine.py  --  Musculoskeletal emergence engine (deterministic, in-package).

SCOPE (see CHARTER.md): Skeletal muscle (the actuator neuro commands), cartilage and bone emerge as load-bearing structures on the jamming substrate; bone remodeling under mechanical load is a yield/jamming threshold (Wolff's law).
...
ORGAN_ROWS = [{'master': 'MYOD1',
  'organ': 'skeletal_muscle',
  'role': 'myogenic contraction: recruitment + force-frequency (the actuator neuro commands)',
  'dyn_class': 'actuator',
  'tau_s': None,
  'rate_note': 'twitch->tetanus fusion freq [L] TO-ANCHOR',
  'gamma_state': 'vendored'},
 {'master': 'SOX9',
  'organ': 'cartilage',
  'role': 'chondrocyte load-bearing matrix + growth plate',
  'dyn_class': 'structural',
  'tau_s': None,
  'rate_note': 'growth-plate ossification timing [L]',
  'gamma_state': 'vendored'},
 {'master': 'TBX5',
  'organ': 'limb_skeleton',
  'role': 'appendicular skeletal patterning (load-bearing scaffold)',
  'dyn_class': 'structural',
  'tau_s': None,
  'rate_note': 'limb bud -> skeleton [V]',
  'gamma_state': 'vendored'},
 {'master': 'RUNX2',
  'organ': 'bone',
  'role': 'osteoblast mineralization + load remodeling (Wolff = yield/jamming)',
  'dyn_class': 'load-remodel',
  'tau_s': None,
  'rate_note': 'bone density vs load [L]; RUNX2 gamma MEASURED 1.2414 (NC_000006.12 + TSS-2000..+500)',
  'gamma_state': 'vendored'}]
OSCILLATOR_ORGANS = []
...
def circulate():
    ...
    return dict(_what="Musculoskeletal -- emerge organs from measured gamma, then circulate dynamics.",
